...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__authenticate_authenticate_component__ = __webpack_require__("../../../../../src/app/authenticate/authenticate.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_clarity_angular__ = __webpack_require__("../../../../clarity-angular/clarity-angular.es5.js");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_6__authenticate_authenticate_component__["a" /* AuthenticateComponent */],
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */].forRoot([
                { path: '', component: __WEBPACK_IMPORTED_MODULE_6__authenticate_authenticate_component__["a" /* AuthenticateComponent */], pathMatch: 'full' },
                { path: 'authenticate', component: __WEBPACK_IMPORTED_MODULE_6__authenticate_authenticate_component__["a" /* AuthenticateComponent */] },
            ...
            __WEBPACK_IMPORTED_MODULE_9_clarity_angular__["a" /* ClarityModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_3__angular_forms__["c" /* FormsModule */],
            __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* ReactiveFormsModule */],
            __WEBPACK_IMPORTED_MODULE_4__angular_http__["c" /* HttpModule */]
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_10__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]],
...
module.exports = "<div class=\"login-wrapper\">\n  <form class=\"login\" [formGroup]=\"loginForm\" (ngSubmit)=\"onLoginSubmit(loginForm.value)\">\n      <label class=\"title\">\n          <h3 class=\"welcome\">Welcome to</h3>\n          TASK TRACKER\n          <h5 class=\"hint\">Use your E-Mail to sign in or create one now</h5>\n      </label>\n      <div class=\"login-group\">\n          <input formControlName=\"email\" class=\"email\" type=\"text\" id=\"login_email\" placeholder=\"E-Mail\">\n          <input formControlName=\"password\" class=\"password\" type=\"password\" id=\"login_password\" placeholder=\"Password\">\n          <div class=\"checkbox\">\n              <input type=\"checkbox\" id=\"rememberme\">\n              <label for=\"rememberme\">\n                  Remember me\n              </label>\n          </div>\n          <div class=\"error active\">\n              Invalid user name or password\n          </div>\n          <button type=\"submit\" class=\"btn btn-primary\">NEXT</button>\n          <a href=\"javascript://\" class=\"signup\">Sign up for a Company ID</a>\n      </div>\n"
...
var AuthenticateComponent = (function () {
    function AuthenticateComponent(authService, router) {
    ...
    AuthenticateComponent.prototype.onLoginSubmit = function (value) {
        var _this = this;
        var user = {
            email: value.email,
    ...
    Object.defineProperty(AuthenticateComponent.prototype, "email", {
        get: function () { return this.loginForm.get('email'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(AuthenticateComponent.prototype, "password", {
...
AuthenticateComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/authenticate/authenticate.component.html"),
        styles: [__webpack_require__("../../../../../src/app/authenticate/authenticate.component.css")]
    }),
...
module.exports = "<div class=\"login-wrapper\">\n  <form class=\"login\" [formGroup]=\"registerForm\" (ngSubmit)=\"onRegisterSubmit(registerForm.value)\">\n      <label class=\"title\">\n          Registration\n          <h5 class=\"hint\">Please, input information about yourself</h5>\n      </label>\n      <div class=\"login-group\">\n          <input formControlName=\"firstname\" class=\"firstname\" type=\"text\" id=\"login_username\" placeholder=\"First Name\">\n          \n          <!-- First Name Errors -->\n          <div *ngIf=\"firstname.touched && firstname.invalid\" class=\"error active\">\n            <div *ngIf=\"firstname.errors.required\">First Name is required</div>\n          </div>\n\n          <input formControlName=\"lastname\" class=\"lastname\" type=\"text\" id=\"login_username\" placeholder=\"Last Name\">\n          \n          <!-- Last Name Errors -->\n\n          <div *ngIf=\"lastname.touched && firstname.invalid\" class=\"error active\">\n            <div *ngIf=\"lastname.errors.required\">First Name is required</div>\n          </div>\n          \n          <input formControlName=\"email\" class=\"email\" type=\"text\" id=\"login_username\" placeholder=\"E-mail\">\n          \n          <!-- E-mail Errors -->\n          <div *ngIf=\"email.touched && email.invalid\" class=\"error active\">\n            <div *ngIf=\"email.errors.required\">E-mail is required</div>\n          </div>\n\n          <input formControlName=\"password\" class=\"password\" type=\"password\" id=\"login_password\" placeholder=\"Password\">\n          \n          <!-- Password Errors -->\n          <div *ngIf=\"password.touched && password.invalid\" class=\"error active\">\n            <div *ngIf=\"password.errors.required\">Password is required</div>\n          </div>\n          \n          <button type=\"submit\" class=\"btn btn-primary\" [disabled]=\"registerForm.invalid\">SIGN UP</button>\n\n      </div>\n  </form>\n</div>\n"
